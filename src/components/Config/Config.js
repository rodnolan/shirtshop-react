      ...
      <div>
        ...
        <div className="main-column row">
          ...
          <div className = "col-12 col-sm-12 col-md-3" classID="configbar">
            <button type="button" className="col-3 col-sm-3 col-md-12 btn-md" classID="config-color">Color</button>
            <button type="button" className="col-3 col-sm-3 col-md-12 btn-md" classID="config-style">Style</button>
            <button type="button" className="col-3 col-sm-3 col-md-12 btn-md" classID="config-size">Size</button>
            <button type="button" className="col-3 col-sm-3 col-md-12 btn-md" classID="config-caption">Caption</button>
          </div>
        </div>
      </div>
    );
